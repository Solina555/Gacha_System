...
public class GachaService {
    ...
    public Card pull(Player player) {
        ...
        System.out.println("[PITY] A-pity: " + consecutiveNoAS + "/" + A_PITY_LIMIT + " | S-pity: " + consecutiveNoS + "/" + S_PITY_LIMIT);
    ...
    private String determineRankWithPity() {
        ...
        if (consecutiveNoS >= S_PITY_LIMIT - 1) {
            System.out.println("[PITY] S-rank pity triggered! After " + consecutiveNoS + " draws without S, you are guaranteed an S-rank card!");
            return "S";
        }
        ...
        if (consecutiveNoAS >= A_PITY_LIMIT - 1) {
            ...
            if (isS) {
                System.out.println("[PITY] A-pity upgraded to S! After " + consecutiveNoAS + " draws without A/S, you get an S-rank card!");
                return "S";
            }
            else {
                System.out.println("[PITY] A-pity triggered! After " + consecutiveNoAS + " draws without A/S, you get an A-rank card!");
                return "A";
            }
        }
        // Normal probability
    ...
    public int getAPityProgress() {
        return consecutiveNoAS;
    }

    public int getSPityProgress() {
        return consecutiveNoS;
    }
}